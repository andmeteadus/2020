...
Laadi Moodle-st alla andmestik [doping.csv](../data/doping.csv) ja loe töökeskkonda. Andmestikus on järgmised tunnused:
...
Laadi Moodle-st alla andmestik [doping_verification.csv](../data/doping_verification.csv). 
